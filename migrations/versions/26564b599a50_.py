...
Revision ID: 26564b599a50
Revises: a5cffa318ac2
Create Date: 2025-04-22 15:37:23.634214
...
def upgrade():
    ...
    op.create_table('relacion_user_people',
    ...
    op.create_table('relacion_user_planeta',
    sa.Column('user_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('relacion_user_planeta')
    op.drop_table('relacion_user_people')
    op.drop_table('users')
